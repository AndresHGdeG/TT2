...
Como se estableció en el objetivo de este trabajo (ver \Tref{cp1:objetivoG}{Objetivo general}), se ha creado una aplicación para recolectar y clasificar noticias, las cuales son mostrados en un entorno web.En esta sección se explica el proceso de funcionamiento de la aplicación web.\\
