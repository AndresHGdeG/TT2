...
from sklearn.svm import SVC #esta libreria nos permite entrenar el algoritmo Naive bayes

clf=SVC(kernel='rbf',gamma='scale')

#clf=SVC(gamma='scale')# gamma mejora la eficiencia del algoritmo, el kernel por default es rbf
